...
_base_ = [
    '../_base_/models/mask2former_beit.py', '../_base_/datasets/samsung_fisheye.py',
...
load_from = 'https://huggingface.co/OpenGVLab/InternImage/resolve/main/mask2former_internimage_h_896_80k_cocostuff2ade20k.pth'
...
evaluation = dict(interval=22000, metric='mIoU', save_best='mIoU')
